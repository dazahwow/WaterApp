...
class GenderScreenOption extends StatefulWidget {
  @override
  _GenderScreenOption createState() => _GenderScreenOption();
}

class _GenderScreenOption extends State<GenderScreenOption> {
  bool isMale = true;
  bool isFemale = false;
            ...
            children: <Widget>[
              ButtonTheme(
                ...
                child: GradientButton(
                  ...
                  elevation: 25,
                  callback: () {
                    Navigator.pushNamed(context, 'ActivityScreenOption');
                  },
                ),
              ),
            ],
